...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__studio__ = __webpack_require__(515);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_slick_carousel_slick_slick__ = __webpack_require__(516);
...
var StudioPage = (function () {
    ...
    StudioPage.prototype.getMyURL = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('bg/imageedit_11_7709009449.png').getDownloadURL().then(function (url) {
            _this.imgSource55 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('bg/imageedit_24_3672429159.png').getDownloadURL().then(function (url) {
            _this.imgSource61 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('bg/gg.PNG').getDownloadURL().then(function (url) {
            _this.imgSource56 = url;
        });
        ...
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('bg/groung1.png').getDownloadURL().then(function (url) {
            _this.imgSource48 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('bg/imageedit_18_6246276166.png').getDownloadURL().then(function (url) {
            _this.imgSource58 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('bg/imageedit_20_7479302737.png').getDownloadURL().then(function (url) {
            _this.imgSource59 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('bg/imageedit_22_5659267894.png').getDownloadURL().then(function (url) {
            _this.imgSource60 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('obj/imageedit_14_5453407336.png').getDownloadURL().then(function (url) {
            _this.imgSource57 = url;
        });
        ///////////////////////////////
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('ENSrXjtl0JdGvoXeHlSTmSBoEIb2/imageedit_1_6300314240.png').getDownloadURL().then(function (url) {
            _this.imgSource50 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('ENSrXjtl0JdGvoXeHlSTmSBoEIb2/imageedit_3_5396431971.png').getDownloadURL().then(function (url) {
            _this.imgSource51 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('ENSrXjtl0JdGvoXeHlSTmSBoEIb2/imageedit_5_5989166460.png').getDownloadURL().then(function (url) {
            _this.imgSource52 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('ENSrXjtl0JdGvoXeHlSTmSBoEIb2/imageedit_7_4051595021.png').getDownloadURL().then(function (url) {
            _this.imgSource53 = url;
        });
        __WEBPACK_IMPORTED_MODULE_2_firebase_app__["storage"]().ref().child('ENSrXjtl0JdGvoXeHlSTmSBoEIb2/imageedit_9_6495039310.png').getDownloadURL().then(function (url) {
            _this.imgSource54 = url;
        });
    };
    StudioPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad StudioPage');
    };
    StudioPage.prototype.activeColor = function (num) {
        this.colorArr = [true, true, true, true, true, true, true];
...
;(function(factory) {
    'use strict';
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(517)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
