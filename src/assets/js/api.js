...
var finalURL="http://lunapic.com/s.jpg";
 function getWidth () {
    ...
    function callLuna(){
      document.getElementById("pic").value=finalURL;
         var winW = getWidth();
    document.cookie = "winw="+ winW +"; path=/; domain=lunapic.com";
...
//document.getElementById('demo').innerHTML= (this.responseText);
         ...
         xhttp.open("GET", "http://192.168.1.108/test/index.php?img="+img2,false);
...
writeUserData(document.getElementById('userInfo').innerHTML);
  ...
  firebase.database().ref(userId).child().push().set({
